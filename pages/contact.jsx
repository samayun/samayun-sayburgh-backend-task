            ...
            <section className="flex flex-col md:flex-row gap-4      p-4 w-full justify-center">
                ...
                <div className="md:w-1/2 order-1">
                    ...
                    <form className="w-full">
                        ...
                        <button className="my-2 py-3 delay-200 text-md uppercase  tracking-wider font-medium text-center w-full rounded-full bg-blue-700 text-gray-50 hover:text-blue-900 hover:bg-transparent border hover:border-blue-900  focus:outline-none " type="submit">Send</button>
